  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.2.7 Exception#
...
//                        documentation ```php
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.2.7 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.2.7 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.2.7 Exception#getCode().
