  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.2.24 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.2.24 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.2.24 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.2.24 Exception#getCode().
