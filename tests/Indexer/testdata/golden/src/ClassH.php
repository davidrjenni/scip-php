  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.3.16 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.3.16 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.3.16 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.3.16 Exception#getCode().
