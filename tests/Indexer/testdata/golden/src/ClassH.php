  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.3.22 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.3.22 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.3.22 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.3.22 Exception#getCode().
