  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.4.13 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.4.13 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.4.13 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.4.13 Exception#getCode().
