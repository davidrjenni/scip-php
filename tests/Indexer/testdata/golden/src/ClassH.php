  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.2.8 Exception#
...
//                        documentation ```php
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.2.8 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.2.8 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.2.8 Exception#getCode().
