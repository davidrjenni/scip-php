  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.2.26 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.2.26 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.2.26 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.2.26 Exception#getCode().
