  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.2.25 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.2.25 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.2.25 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.2.25 Exception#getCode().
