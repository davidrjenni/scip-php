  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.3.17 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.3.17 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.3.17 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.3.17 Exception#getCode().
