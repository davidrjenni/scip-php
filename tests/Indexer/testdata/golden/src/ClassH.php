  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.4.14 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.4.14 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.4.14 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.4.14 Exception#getCode().
