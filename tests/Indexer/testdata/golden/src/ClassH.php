  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.4.12 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.4.12 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.4.12 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.4.12 Exception#getCode().
