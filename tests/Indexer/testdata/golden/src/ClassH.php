  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.3.23 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.3.23 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.3.23 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.3.23 Exception#getCode().
