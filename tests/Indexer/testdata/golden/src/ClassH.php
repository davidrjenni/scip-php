  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.3.20 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.3.20 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.3.20 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.3.20 Exception#getCode().
