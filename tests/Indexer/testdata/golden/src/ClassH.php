  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.3.15 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.3.15 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.3.15 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.3.15 Exception#getCode().
