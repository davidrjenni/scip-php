  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.2.4 Exception#
...
//                        documentation ```php
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.2.4 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.2.4 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.2.4 Exception#getCode().
