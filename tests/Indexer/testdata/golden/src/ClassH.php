  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.2.6 Exception#
...
//                        documentation ```php
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.2.6 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.2.6 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.2.6 Exception#getCode().
