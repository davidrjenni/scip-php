  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.2.15 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.2.15 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.2.15 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.2.15 Exception#getCode().
