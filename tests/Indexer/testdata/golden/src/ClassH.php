  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.2.12 Exception#
...
//                        documentation ```php
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.2.12 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.2.12 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.2.12 Exception#getCode().
