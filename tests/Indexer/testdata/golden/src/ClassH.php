  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.2.23 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.2.23 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.2.23 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.2.23 Exception#getCode().
