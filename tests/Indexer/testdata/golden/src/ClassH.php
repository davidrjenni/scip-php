  ...
  {
      use Exception;
//        ^^^^^^^^^ reference scip-php composer php 8.2.21 Exception#
...
//                        > ```
          {
              parent::__construct();
//            ^^^^^^ reference scip-php composer php 8.2.21 Exception#
//                    ^^^^^^^^^^^ reference scip-php composer php 8.2.21 Exception#__construct().
          }
...
//                          ^^^^^^^ reference scip-php composer php 8.2.21 Exception#getCode().
