...
class Document extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.scip.PositionEncoding position_encoding = 6;</code>
     */
    protected $position_encoding = 0;
     ...
     * @return int
     */
    public function getPositionEncoding()
    {
        return $this->position_encoding;
    }
     ...
     * @return $this
     */
    public function setPositionEncoding($var)
    {
        GPBUtil::checkEnum($var, \Scip\PositionEncoding::class);
        $this->position_encoding = $var;
