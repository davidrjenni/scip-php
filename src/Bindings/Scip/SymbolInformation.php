...
class SymbolInformation extends \Google\Protobuf\Internal\Message
{
     ...
     * symbol.
     *
     * Generated from protobuf field <code>string enclosing_symbol = 8;</code>
     */
    protected $enclosing_symbol = '';
     ...
     * @return string
     */
    public function getEnclosingSymbol()
    {
     ...
     * @return $this
     */
    public function setEnclosingSymbol($var)
    {
        GPBUtil::checkString($var, True);
        $this->enclosing_symbol = $var;
